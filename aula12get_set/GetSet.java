...
public class GetSet {
  public static void main(String[] args) {//main indica que este metodo e o metodo principal do nosso programa
    ...
    //j1.setVidas(100);//Como o metodo que fiz e publico eu posso acessar daqui

    j1.addVidas();//Metodo SET para adicionar vidas

    System.out.printf("%nA quantidade de vidas do jogador 1 e de %d",j1.getVidas());
    System.out.printf("%nA quantidade de vidas do jogador 2 e de %d",j2.getVidas());
    System.out.printf("%nA quantidade de vidas do jogador 3 e de %d",j3.getVidas());
